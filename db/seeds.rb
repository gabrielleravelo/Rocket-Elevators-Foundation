...
data['addresses'].each do |i|
    ...
    number_of_batterries= 0
    while number_of_batterries < rand(1..10) 
    ...
    number_of_batterries += 1 

    number_of_columns = 0
    while number_of_columns < rand(1..10)
    ...
    number_of_elevator = 0
    while number_of_elevator < rand(1..10)
